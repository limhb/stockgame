...
<body>
    ...
    <div class="guide-container">
        ...
        <div class="guide-section">
            <h3>게임 소개</h3>
            <p>가상의 돈으로 진짜 코인 시장을 체험해보세요! 실제 코인 가격을 보면서 여러분의 투자 감각을 시험해볼 수 있습니다.</p>
            <p>5분이라는 짧은 시간 동안 얼마나 많은 수익을 낼 수 있는지 도전해보세요. 전문 투자자가 아니어도 누구나 쉽게 즐길 수 있습니다!</p>
        </div>
        
        <div class="guide-section">
            <h3>게임 규칙</h3>
            <ul>
                <li>시작할 때 100만원의 가상 돈을 받습니다</li>
                <li>게임은 5분 동안 진행됩니다</li>
                <li>실제 코인 시세를 그대로 반영합니다</li>
                <li>XRP, 비트코인, 이더리움, 솔라나, 도지코인 중에서 거래할 코인을 선택할 수 있습니다</li>
                <li>5분 후에 남은 돈이 많을수록 높은 점수를 받습니다</li>
            </ul>
        </div>
        ...
        <div class="guide-section">
            ...
            <div class="important-note">
                <p>⚠️ 도파민 모드는 정말 위험합니다! 초보자에게는 권장하지 않습니다!</p>
            </div>
        </div>

        <div class="guide-section">
            <h3>청산 시스템 이해하기</h3>
            <p>청산은 가격이 너무 불리하게 움직여 더 이상 거래를 유지할 수 없게 되는 상황입니다.</p>
            <ul>
                <li>레버리지가 높을수록 더 쉽게 청산됩니다</li>
                <li>예를 들어, x10 레버리지를 걸면 가격이 약 10% 정도만 불리하게 움직여도 청산됩니다</li>
                <li>x100 레버리지는 약 1% 정도의 불리한 가격 변동만으로도 청산될 수 있습니다</li>
                <li>청산되면 투자금의 95%를 잃게 되니 주의하세요!</li>
                <li>거래를 시작하면 청산가(얼마에 청산되는지)가 표시됩니다</li>
            </ul>
            <div class="important-note">
                <p>💡 청산 계산법: 100 ÷ 레버리지 = 청산까지 필요한 가격 변동 비율</p>
                <p>예: x20 레버리지 → 100 ÷ 20 = 5% 불리한 가격 변동 시 청산</p>
            </div>
        </div>
        ...
        <div class="guide-section">
            ...
            <ul>
                ...
                <li>게임 중에 페이지를 나가면 기록이 사라집니다! 끝까지 집중해주세요</li>
